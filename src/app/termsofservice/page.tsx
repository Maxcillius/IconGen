                ...
                <div className="max-w-4xl mx-auto px-4 py-12">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-8">
                            ...
                            {/* Section 3 */}
                            <section className="bg-gray-800 rounded-lg p-6 shadow-lg">
                                <h2 className="text-2xl font-semibold text-white mb-4">3. Icon Usage & Licensing</h2>
                            ...
                            {/* Sections 4-10 */}
                            {/* Similar sections for 4-10 omitted for brevity but would follow the same pattern */}
