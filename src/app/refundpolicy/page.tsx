      ...
      <div className="min-h-screen bg-gray-900 text-gray-100">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
              <div className="flex items-center space-x-2">
                <CreditCard className="w-6 h-6 md:w-8 md:h-8 text-blue-400" />
        ...
        <main className="container mx-auto px-4 py-6 md:py-8">
          <div className="max-w-4xl mx-auto space-y-8 md:space-y-12">
            ...
            {/* Main Policy */}
            <section className="bg-gray-800 rounded-lg p-4 md:p-8 space-y-4 md:space-y-6">
              <div className="flex items-start space-x-3">
                <AlertCircle className="w-5 h-5 md:w-6 md:h-6 text-amber-400 flex-shrink-0 mt-1" />
            ...
            <section className="space-y-3 md:space-y-4">
              <h2 className="text-xl md:text-2xl font-bold text-blue-400">No Refunds Policy</h2>
              <div className="bg-gray-800 rounded-lg p-4 md:p-6">
                <ul className="space-y-3 md:space-y-4">
                  <li className="flex items-start space-x-3">
                    <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base text-gray-300">All purchases are final. This includes one-time icon packs, credits, and subscription fees.</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base text-gray-300">No partial refunds are issued for unused subscription time or unused generation credits.</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <XCircle className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base text-gray-300">No refunds are granted due to user error (e.g., wrong input, wrong style selection, etc.).</span>
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="space-y-3 md:space-y-4">
              <h2 className="text-xl md:text-2xl font-bold text-blue-400">Transparency and Support</h2>
            ...
            <section className="bg-gray-800 rounded-lg p-4 md:p-6 mt-6 md:mt-8">
              <h2 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Need Help?</h2>
